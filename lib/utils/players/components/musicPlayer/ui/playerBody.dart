...
import 'package:haydikids/utils/players/components/musicPlayer/ui/playerArtwork.dart';
import 'package:haydikids/utils/players/components/musicPlayer/ui/playerControls.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        expandArtwork
            ? Expanded(child: PlayerArtwork(image: artworkFile))
