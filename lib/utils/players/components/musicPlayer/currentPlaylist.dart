...
class MusicPlayerCurrentPlaylist extends StatefulWidget {
  ...
  MusicPlayerCurrentPlaylist({this.blurUIEnabled});

  @override
  _MusicPlayerCurrentPlaylistState createState() =>
      _MusicPlayerCurrentPlaylistState();
}

class _MusicPlayerCurrentPlaylistState
    extends State<MusicPlayerCurrentPlaylist> {
